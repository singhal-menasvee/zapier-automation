    ...
    return (<div className="card bg-secondary text-white p-3 mb-3 border border-dark rounded">
      <div className="card-body">
        ...
        <div className="mb-3">
          ...
          <select id="slackActionType" value={actionType} onChange={(e) => setActionType(e.target.value)} className="form-select form-select-sm bg-dark text-white border-secondary">
        ...
        <div className="mb-3">
          ...
          <input type="text" id="slackChannelId" value={channelId} onChange={(e) => setChannelId(e.target.value)} placeholder="e.g., #general or C1234567890" className="form-control form-control-sm bg-dark text-white border-secondary"/>
        </div>
        ...
        <div className="mb-3">
          ...
          <textarea id="slackMessageText" value={messageText} onChange={(e) => setMessageText(e.target.value)} placeholder="Enter message to send..." rows="3" className="form-control form-control-sm bg-dark text-white border-secondary"></textarea>
        </div>

        <button onClick={handleConnectSlack} disabled={isConnectingSlack} className="btn btn-primary w-100 mt-3">

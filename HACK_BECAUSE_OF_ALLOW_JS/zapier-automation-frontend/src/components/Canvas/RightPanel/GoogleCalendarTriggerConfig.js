    ...
    return (<div className="card bg-secondary text-white p-3 mb-3 border border-dark rounded"> {/* Bootstrap card for styling */}
      <div className="card-body">
        ...
        <div className="mb-3">
          ...
          <select id="triggerType" value={triggerType} onChange={(e) => setTriggerType(e.target.value)} className="form-select form-select-sm bg-dark text-white border-secondary" // Bootstrap form-select
    >
        ...
        <div className="mb-3">
          ...
          <input type="text" id="calendarId" value={calendarId} onChange={(e) => setCalendarId(e.target.value)} placeholder="primary" className="form-control form-control-sm bg-dark text-white border-secondary" // Bootstrap form-control
    />
        </div>
        ...
        <div className="mb-3">
          ...
          <input type="text" id="keywords" value={keywords} onChange={(e) => setKeywords(e.target.value)} placeholder="e.g., 'meeting', 'deadline'" className="form-control form-control-sm bg-dark text-white border-secondary" // Bootstrap form-control
    />
        </div>

        <button onClick={handleConnectGoogle} disabled={isConnectingGoogle} className="btn btn-primary w-100 mt-3" // Bootstrap button
    >

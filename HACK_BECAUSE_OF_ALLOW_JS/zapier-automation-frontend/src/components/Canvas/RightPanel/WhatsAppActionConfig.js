    ...
    return (<div className="card bg-secondary text-white p-3 mb-3 border border-dark rounded">
      <div className="card-body">
        ...
        <div className="mb-3">
          ...
          <select id="whatsAppActionType" value={actionType} onChange={(e) => setActionType(e.target.value)} className="form-select form-select-sm bg-dark text-white border-secondary">
        ...
        <div className="mb-3">
          ...
          <input type="tel" // Use type="tel" for phone numbers
     id="whatsAppPhoneNumber" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} placeholder="e.g., +1234567890" className="form-control form-control-sm bg-dark text-white border-secondary"/>
        </div>
        ...
        <div className="mb-3">
          ...
          <textarea id="whatsAppMessageText" value={messageText} onChange={(e) => setMessageText(e.target.value)} placeholder="Enter message to send..." rows="3" className="form-control form-control-sm bg-dark text-white border-secondary"></textarea>
        </div>

        <button onClick={handleConnectWhatsApp} disabled={isConnectingWhatsApp} className="btn btn-primary w-100 mt-3">

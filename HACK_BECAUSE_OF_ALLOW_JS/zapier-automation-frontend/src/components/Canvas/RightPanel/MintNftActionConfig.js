    ...
    return (<div className="card bg-secondary text-white p-3 mb-3 border border-dark rounded">
      <div className="card-body">
        ...
        <div className="mb-3">
          ...
          <input type="text" id="nftRecipientAddress" value={recipientAddress} onChange={(e) => setRecipientAddress(e.target.value)} placeholder="0x..." className="form-control form-control-sm bg-dark text-white border-secondary"/>
        </div>
        ...
        <div className="mb-3">
          ...
          <input type="url" // Use type="url" for URIs
     id="tokenUri" value={tokenUri} onChange={(e) => setTokenUri(e.target.value)} placeholder="https://example.com/nft/metadata/1" className="form-control form-control-sm bg-dark text-white border-secondary"/>
        </div>
        ...
        <div className="mb-3">
          ...
          <input type="number" id="tokenId" value={tokenId} onChange={(e) => setTokenId(e.target.value)} placeholder="e.g., 123" min="0" className="form-control form-control-sm bg-dark text-white border-secondary"/>
        </div>

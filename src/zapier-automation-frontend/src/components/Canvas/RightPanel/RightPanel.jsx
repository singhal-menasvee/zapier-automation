...
const RightPanel = ({ selectedNode, onNodeConfigChange }) => {
  ...
  return (
    <aside className="right-panel bg-dark text-white p-3 border-start border-secondary"> {/* Bootstrap classes */}
      <div className="panel-header mb-4">
        ...
        {selectedNode ? (
          <>
            ...
            {selectedNode.selectedIntegration && (
        ...
        <>
            ...
            <div className="integrations-grid row row-cols-2 g-3"> {/* Bootstrap grid */}
              <div className="col">
                <IntegrationCard
                  ...
                  color="#34A853"
                  icon="calendar" // Matches getIntegrationIcon in IntegrationCard.jsx
                  onClick={() => {
              ...
              <div className="col">
                <IntegrationCard
                  name="Gmail"
                  color="#EF4444"
                  icon="envelope" // Matches getIntegrationIcon in IntegrationCard.jsx
                  onClick={() => {
                    if (selectedNode && onNodeConfigChange) {
                      onNodeConfigChange(selectedNode.id, {
                        ...selectedNode.config,
              ...
              <div className="col">
                <IntegrationCard
                  name="Slack"
                  color="#2563EB"
                  icon="slack" // Matches getIntegrationIcon in IntegrationCard.jsx
                  onClick={() => {
                    if (selectedNode && onNodeConfigChange) {
                      onNodeConfigChange(selectedNode.id, {
                        ...selectedNode.config,
              ...
              <div className="col">
                <IntegrationCard
                  name="Discord"
                  color="#9333EA"
                  icon="discord" // Matches getIntegrationIcon in IntegrationCard.jsx
                  onClick={() => {
                    if (selectedNode && onNodeConfigChange) {
                      onNodeConfigChange(selectedNode.id, {
                        ...selectedNode.config,
              ...
              <div className="col">
                <IntegrationCard
                  name="WhatsApp"
                  color="#16A34A"
                  icon="whatsapp" // Matches getIntegrationIcon in IntegrationCard.jsx
                  onClick={() => {
                    if (selectedNode && onNodeConfigChange) {
                      onNodeConfigChange(selectedNode.id, {
                        ...selectedNode.config,
          ...
          <div className="smart-contracts-section mt-4">
            ...
            <div className="contract-actions d-flex flex-column gap-3"> {/* Bootstrap flex column with gap */}
              <div className="card bg-secondary border-0 cursor-pointer hover-shadow-lg"
                   onClick={() => {
                     if (selectedNode && onNodeConfigChange) {
                       onNodeConfigChange(selectedNode.id, {
                         ...selectedNode.config,

...
const LeftSidebar = ({ onNavigate, activeItem }) => {
  ...
  return (
    <aside className="left-sidebar">
      <div
        className={`sidebar-item ${activeItem === 'tools' ? 'active' : ''}`}
      ...
      <div
        className={`sidebar-item ${activeItem === 'workflows' ? 'active' : ''}`}
      ...
      <div
        className={`sidebar-item ${activeItem === 'templates' ? 'active' : ''}`}
      ...
      <div
        className={`sidebar-item ${activeItem === 'logs' ? 'active' : ''}`}
